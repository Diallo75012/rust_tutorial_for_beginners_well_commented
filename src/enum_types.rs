...
pub fn issues_at_shibuya_action(issue: &MangaKissaIssue) -> bool {
  ...
  match issue {
    ...
    MangaKissaIssue::OneIssue(_sentence) => issues_at_shibuya(issue),
    MangaKissaIssue::ListOfNumbers(_list_nums) => issues_at_shibuya(issue),
    _ => {
      eprintln!("Not Valid!");
      false
    }
  ...
  */  
  ...
  if let MangaKissaIssue::OneIssue(sentence) = issue {
